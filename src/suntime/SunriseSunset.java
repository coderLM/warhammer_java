...
public final class SunriseSunset {
     ...
     * @see <a href="http://en.wikipedia.org/wiki/Sunrise_equation">Sunrise equation on Wikipedia</a>
     */
    static class SolarEquationVariables {
    ...
    public static double getJulianDate(final Calendar gregorianDate) {
        ...
        System.out.println("000000 millis:::"+gregorianDate.getTimeInMillis());
        ...
        System.out.println("000000 year="+year);
        System.out.println("000000 month="+month);
        System.out.println("000000 day="+day);
        System.out.println("000000 hour="+hour);
        System.out.println("000000 minute="+minute);
        System.out.println("000000 second="+second);
     ...
     * @param longitude   the longitude of the location in degrees julianDay = day (West is negative)
     ...
     * @see <a href="http://en.wikipedia.org/wiki/Sunrise_equation">Sunrise equation on Wikipedia</a>
     */
    public static SolarEquationVariables getSolarEquationVariables(final Calendar day, double longitude) {

        longitude = -longitude;

        // Get the given date as a Julian date.
        final double julianDate = getJulianDate(day);
        System.out.println("000000 julianDate:::"+julianDate);
    ...
    public static Calendar[] getSunriseSunset(final Calendar day,
        ...
        System.out.println("000000 solarEquationVariables:::"+solarEquationVariables.toString());
        longitude = -longitude;
        final double latitudeRad = Math.toRadians(latitude);
        System.out.println("000000 latitudeRad:::"+latitudeRad);//0.6964806193253452
        // Hour angle
        ...
        System.out.println("000001 omega:::"+omega);//1.9093858802301045
